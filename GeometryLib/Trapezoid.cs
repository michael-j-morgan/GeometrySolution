...
public class Trapezoid : IShape
{
    ...
    {
        if (base1 <= 0)
            throw new ArgumentException("Base1 must be positive.", nameof(base1));
        if (base2 <= 0)
            throw new ArgumentException("Base2 must be positive.", nameof(base2));
        if (height <= 0)
    ...
    {
        if (side1 <= 0)
            throw new ArgumentException("Side1 must be positive.", nameof(side1));
        if (side2 <= 0)
            throw new ArgumentException("Side2 must be positive.", nameof(side2));
